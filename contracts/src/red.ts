...
import { Field, Mina, PrivateKey, AccountUpdate, MerkleMap } from 'snarkyjs';

import { HasMerkleMapContract } from './index.js';
...
const txn1 = await Mina.transaction(senderAccount, () => {
  zkApp.addPersona(newRoot);
});
console.log('\nmain: zkApp.addPersona txn1=');
