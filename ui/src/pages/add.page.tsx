...
export default function Add() {
  ...
  const addMartialArt = async (event: any) => {
    ...
    const { martialArt, rank, notfiy, instructorAddress } =
    ...
    let studentData = {
      ...
      publicKey: PublicKey.fromBase58(
        "B62qpXhnspHhPEknMdr8Sr2wUBgDzUozW4eMPAfPdNAdPN6TW7erN37"
      ),
    ...
    alertRepo.alertInstructor(
      student.id.toBigInt().toString(),
  ...
  return (
    <Master>
      <AuthPage validate={false}>
        <p className={styles.tagline}>Add your Martial Art</p>

        <form onSubmit={addMartialArt}>
          <div className="space-y-12">
            <div className="border-b border-gray-900/10 pb-12">
              <p className="mt-1 text-sm leading-6 text-gray-600">
                Select your martial art and rank to begin your journey.
              </p>
                    ...
                    <div className="relative flex gap-x-3">
                      ...
                      <div className="text-sm leading-6">
                        ...
                        <p className="text-gray-500">
                          Send a notfication to your instructor so that you can
                          get verified.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="sm:col-span-4">
                    ...
                    <div className="mt-2">
                      <input
                        ...
                        type="text"
                        autoComplete="instructor-address"
